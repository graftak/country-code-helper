...
namespace Graftak\CountryCodeHelper;

/**
 * Class CountryCodes
 *
 * Container for ISO-3166-1 country codes and type constants.
...
class CountryCodes
{
     ...
     * @const int
     */
    const SHORT_NAME_FRENCH = 4;

    /**
     * @var array Available code types.
     */
    public static $types = [
        self::ALPHA_2,
        self::ALPHA_3,
        self::NUMERIC,
        self::SHORT_NAME_ENGLISH,
        self::SHORT_NAME_FRENCH
    ];

    /**
     * @var array Column index.
     */
